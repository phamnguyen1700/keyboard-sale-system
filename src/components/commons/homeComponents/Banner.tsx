        ...
        >
          <h1
            style={{
              ...
              lineHeight: 1,
              letterSpacing: -2,
              textShadow: "2px 4px 0 lightgray",
            }}
          >
            FREAKEYCAPS
          </h1>
          ...
          <div style={{ color: "#666", fontSize: 18, marginBottom: 32 }}>
            Browse through our diverse range of standard and custom-made artisan
            keycaps
          </div>
          <Button
          ...
          <Row gutter={0} style={{ marginTop: 32, textAlign: "center" }}>
            ...
            >
              ...
              <div style={{ color: "#666", fontSize: 14 }}>
                Purchase more high-end products,
                <br />
